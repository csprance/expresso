...
Object.defineProperty(extension, "photoshop", {
  value: new PhotoshopInterface(),
  enumerable: true,
});
Object.defineProperty(extension, "imageExporter", {
  value: new ImageExporter(extension.photoshop),
  enumerable: true,
});
extension.on("unload", () => {
  try {
    extension.photoshop.disconnect();
  } catch (e) {}
});

// Create the UI
Object.defineProperty(extension, "ui", {
  value: new ExporterPanel(),
  enumerable: true,
});
