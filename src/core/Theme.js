...
export default class Theme extends EventEmitter {
  ...
  get supportedThemes() {
    return supportedThemes.slice(0);
  }
  ...
  get isActiveThemeLight() {
    return (
      this._activeTheme === supportedThemes[0] ||
      this._activeTheme === supportedThemes[3]
    );
  }
  ...
  updateTheme() {
    ...
    if (panelBackgroundColor == 52 || panelBackgroundColor == 50) {
      //0x343434 || 0x323232
      // Dark
      theme = "dark";
      this.style.backgroundColor =
        panelBackgroundColor == 52 ? "#343434" : "#323232";
    } else if (panelBackgroundColor == 214 || panelBackgroundColor == 240) {
      //0xd6d6d6 || 0xf0f0f0
      // Light
      theme = "light";
      this.style.backgroundColor =
        panelBackgroundColor == 214 ? "#d6d6d6" : "#f0f0f0";
    } else if (panelBackgroundColor == 184) {
      //0xb8b8b8
      // Medium-light
      theme = "medium-light";
      this.style.backgroundColor = "#b8b8b8";
    } // Fallback to Medium-dark 0x535353 or 83
    else {
      theme = "medium-dark";
